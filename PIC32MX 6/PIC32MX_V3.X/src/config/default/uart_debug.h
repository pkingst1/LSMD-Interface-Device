/*******************************************************************************
  ...
  Summary:
    Public interface for UART1 command reception and processing.

  Description:
    Provides callback registration and the main-loop processing function
    for receiving and acting on text commands over UART1.
*******************************************************************************/
...
// UART_Debug_Init
//
// Registers the RX callback and arms the first UART1 read.
...
// UART_Debug_Send
//
// Sends a null-terminated string over UART1 using the shared TX buffer.
